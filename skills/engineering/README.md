# Shiki Engineering Skills

These skills are required execution controls for Shiki Target Repositories. They are not optional style preferences: when a trigger applies, the relevant skill must be invoked and recorded as Skill Gate evidence before MergeGate can mark work ready.

See `../../docs/agents/skill-gate.md` for the full required-skill matrix.
