...
def build_parser() -> argparse.ArgumentParser:
    ...
    init.add_argument("--force", action="store_true", help="Refresh template files (required for an upgrade). Project-content and governance files are kept and written alongside as <file>.new; migration state is preserved; everything else is overwritten.")
    ...
    target.add_argument("--force", action="store_true", help="Refresh template files (required for an upgrade). Project-content and governance files are kept and written alongside as <file>.new; migration state is preserved; everything else is overwritten.")
    ...
    start.add_argument("--force", action="store_true", help="Refresh template files during init (required for an upgrade). Project-content and governance files are kept and written alongside as <file>.new; migration state is preserved; everything else is overwritten.")
